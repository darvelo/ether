...
describe('sendTo()', () => {
    describe('init() spies', () => {
        it('waits for init() to be called before firing sendTo()', () => {
            resetSpies();
            let rootApp = new MyRootApp({});
            spies.InitSendToRoute.sendToSpy.should.not.have.been.called;
            spies.InitConditionalSendToRoute.sendToSpy.should.not.have.been.called;
            rootApp._inits.then(() => {
                spies.InitSendToRoute.sendToSpy.should.have.been.calledOnce;
                spies.InitSendToRoute.sendToSpy.should.have.been.calledWith('InitReceiveRoute');
                spies.InitConditionalSendToRoute.sendToSpy.should.have.been.calledOnce;
                spies.InitConditionalSendToRoute.sendToSpy.should.have.been.calledWith('InitConditionalReceiveRoute');
            });
        });
    });

    describe('non-init() spies', () => {
        let rootApp;
